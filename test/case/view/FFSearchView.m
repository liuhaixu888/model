...
{
    FFSearchView *view = [[FFSearchView alloc] initWithFrame:CGRectMake(23, 0, [[UIScreen mainScreen] bounds].size.width - 70, 40)];
    view.done = done;
    view.backgroundColor = RGBCOLOR(242, 244, 247);
    view.layer.masksToBounds = YES;
    view.layer.cornerRadius = 5;
    UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(35, 0, view.width - 25, view.height)];
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(7, 7.5, 25, 25)];
...
//    }
   ...
   // [[UIApplication sharedApplication].root.view addSubview:_tapControl];
