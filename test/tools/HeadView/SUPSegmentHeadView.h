...
@protocol SUPSegmentHeadViewDelegate <NSObject>
...
@end
@interface SUPSegmentHeadView : UIView

@property (nonatomic, weak) id<SUPSegmentHeadViewDelegate> delegate;
...
@interface SUPSegmentViewCell : UICollectionViewCell
